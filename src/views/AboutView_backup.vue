...
<button 
            ...
            <div v-if="configStore.isEditing" class="preset-selector">
              <select @change="loadPreset(($event.target as HTMLSelectElement).value)" class="preset-select">
        ...
        <div class="config-section">
          ...
          <div class="calculated-values">
            ...
            <div class="calc-grid">
              ...
              <div class="calc-item">
                <strong>Window-to-Floor Ratio:</strong> {{ configStore.getWindowToFloorRatio().toFixed(1) }}%
              </div>
            </div>
          </div>
        </div>
